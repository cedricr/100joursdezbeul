<script lang="ts">
	...
	import { LEADERBOARD, LEADERBOARD_REGION, METADATA, getDayNumber, getDepartmentName, getRegionName } from '$lib/utils';
...
<main role="main">
	...
	<div class="mx-auto mb-6 mt-10 max-w-5xl text-xl flex justify-between items-start flex-wrap">
		<table class="ranking">
			<thead>
			<tr>
